...
class Assertions {
    checkElementState(element, expectedState, timeout, message = `Element state assertion failed`) {
    ...
    checkValue(value, expected, assertionType, message = `Assertion failed`) {
        return __awaiter(this, void 0, void 0, function* () {
