...
class PageActions {
    ...
    waitForPageToLoad() {
        return __awaiter(this, arguments, void 0, function* (timeout = 100000) {
    ...
    checkIfMessagesDisappear() {
        return __awaiter(this, arguments, void 0, function* (timeout = 30000, messages = (0, index_js_2.getLoadingMessages)()) {
            const startTime = Date.now();
    ...
    fillADropDown(dropDownLocator, value) {
        return __awaiter(this, void 0, void 0, function* () {
            const dataToFill = yield this.processEnv.getEnvVarOrDefault(value);
